...
curl -s -u "admin:gSsVEgt9x5LoulzsNf0bzQ" -X POST "http://localhost:5151/api/v1/blueprints/$BP_ID/approve-and-schedule" -H "Content-Type: application/json" | python3 -m json.tool
```
