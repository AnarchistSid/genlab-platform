...
export function GamingDetailView({ item }: DetailViewProps) {
  ...
  return (
    <div className="flex flex-col gap-4 overflow-y-auto pr-2">
      ...
      {item.hook_text && (
        <div>
          <div className="mb-1 flex items-center gap-1.5">
            <Gamepad2 className="size-3.5" style={{ color: "var(--niche-current)" }} />
      ...
      <div className="flex items-center gap-3">
        ...
        {item.format && (
          <span
            className="rounded px-2 py-0.5 text-xs font-medium uppercase bg-bg-elevated"
