...
class TestPublishingAnalyticsCRUD:
    ...
    def test_create_and_get(self, pg_backend):
        record_id = pg_backend.create("publishing_analytics", {
    ...
    def test_update(self, pg_backend):
        ...
        pg_backend.update("publishing_analytics", record_id, {
            "views": 5000,
            "likes": 400,
            "metrics_fetched": True,
        })
    ...
    def test_find_by_platform(self, pg_backend):
        ...
        pg_backend.create("publishing_analytics", {
            "niche_id": _TEST_NICHE,
            "post_id": pid,
            "platform": "facebook",
            "status": "PUBLISHED",
...
class TestAnalyticsCRUD:
    ...
    def test_create_and_get(self, pg_backend):
        record_id = pg_backend.create("analytics", {
            "niche_id": _TEST_NICHE,
            "post_id": "an_post_1",
            "platform": "instagram",
            "metric_type": "views",
