...
def _main_with_durable_error() -> int:
    ...
    try:
        ...
        # Late import so this script keeps working even if it's run
        # from an environment where genlab_core isn't yet installed
        # (e.g. dev bootstrap).
        try:
            ...
            write_durable_error("scrape_affiliate_revenue", exc)
