...
|---------|--------|--------|----------|
| Amazon IN | LIVE | India | aspirehub-21 |
| Amazon US | LIVE | US/Global | aspirehub06-20 |
| Cuelinks | LIVE | India | cid=272705 |
...
2. Associate all Amazon Associates tags: `aspirehub-21` (IN), `aspirehub06-20` (US), plus new tags for UK/DE/JP/CA/AU
3. OneLink provides a base URL format: `https://www.amazon.com/dp/{ASIN}?tag=aspirehub06-20&linkCode=ll1&language=en_US`
  ...
  -> /links/go/{slug}
    ...
    -> 302 redirect to Amazon OneLink URL
      -> Amazon detects user geo
        -> IN user -> amazon.in/dp/{ASIN}?tag=aspirehub-21
        -> US user -> amazon.com/dp/{ASIN}?tag=aspirehub06-20
...
settings:
  amazon_onelink:
    enabled: true
    default_tag: aspirehub06-20  # US tag (OneLink associates local tags automatically)
    tags:
      IN: aspirehub-21
      US: aspirehub06-20
...
# BEFORE (Phase 1):
networks:
  amazon: { url: "https://www.amazon.in/dp/B0CY5QW186?tag=aspirehub-21", commission_pct: 3.0 }
  amazon_us: { url: "https://www.amazon.com/dp/B0DJHG2VVS?tag=aspirehub06-20", commission_pct: 3.0 }

# AFTER (v2):
networks:
  amazon_onelink: { url: "https://www.amazon.com/dp/B0DJHG2VVS?tag=aspirehub06-20&linkCode=ll1", commission_pct: 3.0 }
```
...
class AmazonOneLinkAdapter:
    ...
    default_tag: str = "aspirehub06-20"
...
- name: "Nike Running Shoes"
  ...
  category: gear
  networks:
    amazon_onelink: { url: "https://www.amazon.com/dp/B0C8THZHJ5?tag=aspirehub06-20&linkCode=ll1", commission_pct: 4.0 }
    impact: { url: "https://aspirehub.sjv.io/c/XXXX/nike/shoes", commission_pct: 8.0 }
    cuelinks: { url: "https://linksredirect.com/?cid=272705&...", commission_pct: 7.5 }
```
...
Credentials:
  ...
  - PAAPI_PARTNER_TAG -- aspirehub06-20 (US tag, OneLink handles geo)
"""
...
PAAPI_PARTNER_TAG=aspirehub06-20
PAAPI_ENABLED=true
```
